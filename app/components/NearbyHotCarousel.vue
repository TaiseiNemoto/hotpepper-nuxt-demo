    ...
    <div class="mx-auto max-w-7xl px-12">
      ...
      <div v-else class="relative" data-test="nearby-carousel">
        ...
        <button
          v-if="showPrevButton"
          type="button"
          class="absolute -left-6 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-lg ring-1 ring-gray-200 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-50"
        ...
        <div
          ...
          class="flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth pb-4 scrollbar-hide"
